...
var ChatGPTAPI = /** @class */ (function () {
     ...
     */
    ChatGPTAPI.prototype.sendMessage = function (text, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        parentMessageId = opts.parentMessageId, _a = opts.messageId, messageId = _a === void 0 ? (0, uuid_1.v4)() : _a, timeoutMs = opts.timeoutMs, onProgress = opts.onProgress, _b = opts.stream, stream = _b === void 0 ? onProgress ? true : false : _b, completionParams = opts.completionParams, conversationId = opts.conversationId;
                        ...
                        return [4 /*yield*/, this._buildMessages(text, opts)];
                    case 1:
                                            ...
                                            onMessage: function (data) {
                                                ...
                                                try {
                                                    ...
                                                    if ((_a = response.choices) === null || _a === void 0 ? void 0 : _a.length) {
                                                        ...
                                                        //获取token 发出来
                                                        var promptTokens = numTokens;
                                                        var completionTokens = _this.getTokenCount(result.text);
                                                        result.detail.usage = {
    ...
    ChatGPTAPI.prototype._buildMessages = function (text, opts) {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 1:
                        prompt_1 = nextMessages
                            ...
                            switch (message.role) {
                                ...
                                default:
                                    return prompt.concat(["".concat(assistantLabel, ":\n").concat(message.content)]);
                            }
                        }, [])
                            .join('\n\n');
    ...
    ChatGPTAPI.prototype.getTokenCount = function (text) {
        text = text.replace(/<\|endoftext\|>/g, '');
