...
var stream_async_iterable_1 = require("./stream-async-iterable");
function fetchSSE(url, options, fetch) {
    var _a, e_1, _b, _c;
    if (fetch === void 0) { fetch = fetch_1.fetch; }
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 7:
                    ...
                    _d = true, _e = __asyncValues((0, stream_async_iterable_1.streamAsyncIterable)(res.body));
                    _g.label = 8;
